         ...
         <!-- Modal tambah -->
          ...
          <div class="modal-dialog modal-dialog-centered " role="document">
            ...
            <ul class="list-group list-group-flush">
              ...
              <small id="emailHelp" class="form-text text-muted">Nilai pinjaman maksimal 15% dari simpanan</small>
            </ul>            
            <br>    
            <div class="form-group">
              <label for="jml_pinjam">Masukan Jumlah Pinjaman</label>
              <input type="number" class="form-control  @error('jml_pinjam') is-invalid @enderror" value="{{ old('jml_pinjam') }}"id="jml_pinjam" name="jml_pinjam" placeholder="Masukan Jumlah Pinjaman">
              @error('jml_pinjam')
            ...
            @enderror
              ...
              <div class="form-group">
                ...
                <input type="hidden" class="form-control  @error('bunga') is-invalid @enderror" value="5" id="bunga" name="bunga" readonly>
                @error('bunga' )
                  <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
