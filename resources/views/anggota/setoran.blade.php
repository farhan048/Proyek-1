              ...
              <div class="alert alert-success" role="alert">
                ...
                <div class="modal-dialog modal-dialog-centered " role="document">
                  <div class="modal-content">
                    ...
                    <div class="form-group">
                      <label for="inputState">Jenis Simpanan</label>
                      <select id="inputState" class="form-control @error('jenis_simpanan') is-invalid @enderror" value="{{ old('jenis_simpanan') }}"  name="jenis_simpanan">
