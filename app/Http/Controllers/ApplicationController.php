...
class ApplicationController extends Controller
{
    ...
    {
        $request->validate([
            'jml_pinjam'            => 'required|regex:/^[0-9]*$/|numeric',
            'jml_anggsuran'         => 'required',
        ],
        [
            'required'              => "Tidak Boleh Kosong",
            'jml_pinjam.regex'      => 'Inputan Tidak Boleh Minus dan Lebih Besar dari 0',
        ]);
        $total = ($request->jml_pinjam * 0.05) + $request->jml_pinjam;
        $form_data = array(
